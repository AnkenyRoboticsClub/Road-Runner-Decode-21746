...
@Autonomous(name = "AutoRedBackV2", group = "Autonomous")
public class AutoRedBackV2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Action exitLaunchZone = drive.actionBuilder(new Pose2d(55, 20, Math.toRadians(160)))
